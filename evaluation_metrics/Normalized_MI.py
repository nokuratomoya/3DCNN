...
def main():
    ...
    for a in a_list:
        ...
        calc_3D_NMI(model_path, results_predict_path, eval_file_path, index="NMI")  # index : MSE or PSNR


def calc_3D_NMI(model_path, results_path, eval_file_path, index="NMI"):
    ...
    for eval_file_name in eval_file_all:
        ...
        if eval_file_name in used_filename:
            ...
            for pre_img in pre_images:
                ...
                NCC_one.append(skimage.metrics.normalized_mutual_information(ori_img, pre_img))
